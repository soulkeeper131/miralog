    ...
    function build() {
        ...
        wrap.innerHTML =
            '<div class="consent-text">' +
                '<strong>Пазим само необходимото.</strong> ' +
                'За да останеш вписан и темата ти да се помни, съхраняваме ' +
                'три неща в браузъра ти. Нямаме реклами, нямаме проследяване ' +
                'и не споделяме нищо с трети страни. ' +
